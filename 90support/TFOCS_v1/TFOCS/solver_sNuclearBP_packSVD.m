function varargout = solver_sNuclearBP_packSVD( omega, b, mu, x0, z0, opts, varargin )
...
if isempty(x0)
    x0 = packSVD(n1,n2); % force it to be zeros!  Need to change this.
end

[varargout{1:max(nargout,1)}] = ...
    tfocs_SCD( prox_nuclear, { A, -b }, proj_Rn, mu, x0, z0, opts, varargin{:} );
