...
%         Description''}');
        ...
        desc.maxCounts = 'Advanced. Vector that fine-tunes various types of iteration limits';
        desc.countOps = 'Advanced. Record number of linear multiplies, etc.';
        ...
        desc.printEvery = 'Basic.  How often to print info to the terminal';
        desc.maxmin = 'Basic. +1 for convex manimization, -1 for concave maximization';
        ...
        desc.stopCrit = 'Advanced. Controls which stopping criteria to use; 1 or 2.';
        desc.restart = 'Basic. Restart parameter. Make negative for "no-regress" feature';
        desc.alg = 'Algorithm, e.g. GRA for gadient descent';
...
if nargin >= 4
    x0_types = {'cell','double','tfocs_tuple'};
